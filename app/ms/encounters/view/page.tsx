						...
						<div className='space-y-3 pt-5'>
							...
							<div id='admission' className='flex gap-3 flex-wrap'>
								...
								<Text className='flex gap-1 items-center'>
									Days of Admission:
									<i className='text-sm'>
										{queryData?.admission?.admitted_for}
									</i>
								</Text>
								<Text className='flex gap-1 items-center'>
									Date of Discharge:
						...
						{queryData?.care?.name == "Delivery" && (
							<div id='delivery' className='flex flex-col gap-2 flex-wrap'>
								...
								<div id='del' className='pl-4 flex-wrap flex gap-3'>
									...
									<Text>
										Delivery Type:{" "}
										<i>{queryData?.delivery[0]?.delivery_type}</i>
									</Text>
									<Text>
										Mother Diagnosis:{" "}
										<i>{queryData?.delivery[0]?.mother_diag}</i>
									</Text>
									<Text>
										Mother Outcome:{" "}
							...
							<div id='operation' className='flex gap-2 flex-wrap'>
								<div>
									...
									<div id='op' className='pl-4 flex-wrap flex gap-6'>
										...
										<Text>
											Anaesthesia:{" "}
											<i>{queryData?.operations[0]?.anaesthesia}</i>
										</Text>
										<Text>
											Operation Outcome:{" "}
							...
							<div id='ANC' className='flex gap-2 flex-wrap'>
								<div>
									...
									<div id='anc' className='pl-4 flex-wrap flex gap-6'>
										...
										<Text>
											Placenta Position:{" "}
											<i>{queryData?.anc[0]?.placenta_pos}</i>
										</Text>
									</div>
								</div>
							</div>
								...
								<div className='flex items-start gap-4 mb-2'>
									...
									<div className='space-y-1 w-full'>
										...
										<p className='text-lg font-extrabold bg-black text-white p-1 px-2 text-center uppercase'>
											Prescriptions for Hosp No: {queryData?.patient?.hosp_no}{" "}
											on {new Date(queryData?.enc_date).toLocaleDateString()},{" "}
											{queryData?.time}
										</p>
									</div>
								</div>
